# team-colors Specification

## Purpose

Every match is assigned two distinct, persisted team colors drawn at random from a palette that excludes the brand color, and the match page renders each team in its color.
