...
Provide an account-less, cookie-based way for unauthenticated users to identify themselves by name so the app can recognize and address them across visits, without passwords or sessions.
