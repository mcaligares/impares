...
Every animation introduced or modified by this capability — the button shimmer, the team-entrance slides, and the confetti — SHALL be suppressed or reduced when the user has `prefers-reduced-motion: reduce` set, leaving content fully visible and usable.
